...
func (m *Module) Description() string { return "TR-069 scanner (CWMP) with heuristics scoring" }

func init() {
	var module Module
	_, err := zgrab2.AddCommand("tr069", "TR-069 scanner (CWMP)", module.Description(), 7547, &module)
	if err != nil {
		panic(err)
	}
}
...
func (s *Scanner) Protocol() string { return "tr069" }
